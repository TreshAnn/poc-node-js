...
export default function Home() {
  ...
  let [isToastOpen, setIsToastOpen] = useState(false);
  ...
  return (
    <ToastProvider swipeDirection="right">
      <div className="antialiased bg-slate-200 text-slate-700 mx-2">
          ...
          <div id="tasks" className="my-5">
            ...
            >
              <div className="inline-flex items-center space-x-2">
                <div className="text-slate-500 ">User 1</div>
              </div>
              <div>
                <svg
            ...
            >
              <div className="inline-flex items-center space-x-2">
                <div className="text-slate-500 ">User 2</div>
              </div>
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <Toasty isOpen={isToastOpen} closeToast={()=>{setIsToastOpen(false)}} />
      </div>
    </ToastProvider>
  );
}
